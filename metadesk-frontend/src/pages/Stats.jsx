...
<Link className="flex items-center gap-4 px-3 py-3 rounded-xl transition-all text-slate-400 hover:text-slate-200 hover:bg-white/5 font-label uppercase tracking-wider text-[11px] font-bold" to="/">
...
<Link className="flex items-center gap-4 px-3 py-3 rounded-xl transition-all bg-blue-600/10 text-blue-400 border-r-2 border-blue-500 font-label uppercase tracking-wider text-[11px] font-bold" to="/stats">
...
<Link className="flex items-center gap-4 px-3 py-3 rounded-xl transition-all text-slate-400 hover:text-slate-200 hover:bg-white/5 font-label uppercase tracking-wider text-[11px] font-bold" to="/settings">
...
{/*  WhatsApp  */}
<circle cx="18" cy="18" fill="transparent" r="15.915" stroke="#009945" strokeDasharray="45 55" strokeDashoffset="0" strokeWidth="4"></circle>
{/*  Instagram  */}
<circle cx="18" cy="18" fill="transparent" r="15.915" stroke="#dc2743" strokeDasharray="35 65" strokeDashoffset="-45" strokeWidth="4"></circle>
{/*  Messenger  */}
<circle cx="18" cy="18" fill="transparent" r="15.915" stroke="#00125a" strokeDasharray="20 80" strokeDashoffset="-80" strokeWidth="4"></circle>
</svg>
